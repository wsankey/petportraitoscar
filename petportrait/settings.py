...
STATICFILES_DIRS = (
    location('petportrait/static/oscar/css/'),
)
STATICFILES_FINDERS = (
...
#Overriding Oscar Settings
OSCAR_SHOP_NAME = 'Pet Portrait Club'
OSCAR_SHOP_TAGLINE = 'Find an artist for your friend'